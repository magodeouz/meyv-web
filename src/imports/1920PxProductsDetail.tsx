import svgPaths from "./svg-0dp63v6w8b";
import imgCta from "@/assets/f545fb012473769fce3efa3563fbf3bf2fa441d0.png";
import imgImage from "@/assets/f7e2551cb869ca3bcf26a39b607254ba142ad1ae.png";
import imgImage1 from "@/assets/6c3d626ccfa29c270df4cea4a3c68cab9a0ebc7b.png";
import imgImage2 from "@/assets/27f5b63142058765da03e8c1f7d233fd84aafe26.png";
import imgImage3 from "@/assets/e6b0ff8832c4cd3c5e8c49a8286fa65d4d1c37d1.png";
import imgImage66 from "@/assets/ffeba28eb520fc86d5a21d336c1c9fc39ddb9b41.png";
import imgSubtract from "@/assets/9d653691428d97fcc29414b2816c940cfe1b17de.png";
import imgRectangle16 from "@/assets/da6f214df68e9135ea7da87f3a6afad486061d61.png";
  ...
  return (
    <div className="h-[64px] relative shrink-0 w-[132.489px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 133 64">
        <g clipPath="url(#clip0_1_849)" id="Layer_1">
          ...
          <g id="Group">
            <path d={svgPaths.p410e800} fill="url(#paint0_linear_1_849)" id="Vector_5" />
            <path d={svgPaths.p2f949000} fill="url(#paint1_linear_1_849)" id="Vector_6" />
            <g id="Group_2">
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_849" x1="54.3525" x2="50.634" y1="63.3711" y2="46.5562">
            <stop stopColor="#72BF44" />
            <stop offset="1" stopColor="#007932" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_1_849" x1="19.1797" x2="54.1336" y1="52.8126" y2="45.0812">
            <stop stopColor="#72BF44" />
            <stop offset="1" stopColor="#007932" />
          </linearGradient>
...
function Cta() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[60px] h-[450px] items-center justify-center left-0 top-[2596px] w-[1920px]" data-name="CTA">
...
function Layer1() {
  return (
    <div className="relative size-[40px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g clipPath="url(#clip0_1_843)" id="Layer_1">
...
function Layer2() {
  return (
    <div className="relative size-[40px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g clipPath="url(#clip0_1_840)" id="Layer_1">
...
function Logo() {
  return (
    <div className="h-[64px] relative shrink-0 w-[132.489px]" data-name="Logo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 133 64">
        <g clipPath="url(#clip0_1_821)" id="Logo">
          <path d={svgPaths.p2c2b4370} fill="var(--fill-0, #19459D)" id="Vector" />
          <path d={svgPaths.p29295e00} fill="var(--fill-0, #19459D)" id="Vector_2" />
          <path d={svgPaths.p3209fa00} fill="var(--fill-0, #19459D)" id="Vector_3" />
          <path clipRule="evenodd" d={svgPaths.p1edaac70} fill="var(--fill-0, #19459D)" fillRule="evenodd" id="Vector_4" />
          <g id="Group">
            <path d={svgPaths.p410e800} fill="url(#paint0_linear_1_821)" id="Vector_5" />
            <path d={svgPaths.p2f949000} fill="url(#paint1_linear_1_821)" id="Vector_6" />
            <g id="Group_2">
              <path d={svgPaths.p98c4c70} fill="var(--fill-0, #CFE5AE)" id="Vector_7" />
            </g>
            <g id="Group_3">
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_821" x1="54.3525" x2="50.634" y1="63.3711" y2="46.5562">
            <stop stopColor="#72BF44" />
            <stop offset="1" stopColor="#007932" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_1_821" x1="19.1797" x2="54.1336" y1="52.8126" y2="45.0812">
            <stop stopColor="#72BF44" />
            <stop offset="1" stopColor="#007932" />
          </linearGradient>
...
function Footer() {
  return (
    <div className="absolute bg-white bottom-[9px] content-stretch flex flex-col gap-[100px] items-start left-0 w-[1920px]" data-name="Footer">
      <Top />
      <Mid />
      <Subfooter />
    </div>
...
export default function Component1920PxProductsDetail() {
  return (
    <div className="bg-white relative size-full" data-name="1920px - Products Detail">
      ...
      <Frame19 />
      <Frame40 />
      <div className="absolute h-[706px] left-[280px] rounded-[40px] top-[605px] w-[664px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[40px] size-full" src={imgRectangle16} />
      </div>
      <Frame47 />
      <Footer />
    </div>
