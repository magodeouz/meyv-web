...
import imgCta from "@/assets/82c4c538c30244afbdb7308a18a81b162d0d8d85.png";
import imgImage66 from "@/assets/ffeba28eb520fc86d5a21d336c1c9fc39ddb9b41.png";
import imgImage52 from "@/assets/28fdde54e479f431a04fc07387aa5c4edfde500f.png";
import imgImage53 from "@/assets/bec3804e00991c27344aa5b0a422b5fe5f8ffa81.png";
import imgRectangle19 from "@/assets/88e57f1c4d0b5499fe43641635829d433e0f76fd.png";
import imgRectangle20 from "@/assets/36e16d20d7eba77888bf886dcc2d41a5c8f94530.png";
import imgSubtract from "@/assets/c37c4930ca3d2e3773dfb95db779ee4b9e0318c7.png";
...
export default function Component1920PxProducts() {
  return (
    <div className="bg-white relative size-full" data-name="1920px - Products">
      ...
      <div className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[620.5px] not-italic text-[48px] text-center text-nowrap text-white top-[1113px] tracking-[-0.96px] translate-x-[-50%] whitespace-pre">
      ...
      <Frame10 />
      <div className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[1308.5px] not-italic text-[48px] text-center text-nowrap text-white top-[1113px] tracking-[-0.96px] translate-x-[-50%] whitespace-pre">
